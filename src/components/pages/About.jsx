  ...
  return (
    <div className="bg-white text-gray-800  ">
      ...
      >
        ...
        <h1 className="relative z-10 text-5xl md:text-6xl font-bold text-[#7ED957]">
          আমাদের সম্পর্কে
        </h1>
      </div>

      {/* Company Overview */}
      <div className="grid grid-cols-2 gap-10 px-[8%] mt-[5%] items-center  ">
        {/* left side  */}
        <div className=" space-y-6">
          <h2 className="text-3xl font-bold text-[#7ED957] ">
            কোম্পানি ওভারভিউ
          </h2>
        ...
        <div className="flex gap-2.5 ">
          <img
            src={land02}
            alt="Land Survey "
            className=" w-[270px]  h-[400px] rounded-2xl shadow-lg "
          />
          <img
            src={land03}
            alt="Land surveying"
            className="w-[304px] h-[300px] mt-[17%] rounded-2xl shadow-lg "
          />
        </div>
      </div>

      {/* Who We Are  */}
      <div className="flex  px-[8%] gap-24 mt-[5%] bg-gray-50 py-8  items-center  ">
        {/* left side */}
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-[#7ED957]">আমরা কারা</h2>
          <div>
            <h3 className="text-xl font-semibold text-[#7ED957]">
        ...
        <div className="">
          <img
            ...
            className=" h-[85%] w-[100%] rounded-2xl shadow-lg"
          />
        </div>
      </div>
      ...
      {/* Why Trust Us */}
      <section className="px-[8%] py-16 grid grid-cols-2 gap-16 items-center">
        <img
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p>
              ...
              যেন আপনার জমি সংক্রান্ত সমস্যার সমাধান সহজ হয়।
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 text-white">
          ...
          <a
            ...
            className="bg-[#7ED957] text-black px-6 py-3 rounded-full font-semibold"
          >
            এখনই যোগাযোগ করুন
          </a>
        </div>
