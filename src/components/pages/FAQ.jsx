...
const faqs = [
  {
    question: "জিমেযাগ কী?",
    answer:
      "জিমেযাগ একটি ডিজিটাল প্ল্যাটফর্ম যেখানে আপনি জমি সংক্রান্ত বিস্তৃত জ্ঞান পাবেন এবং ভেরিফাইড সার্ভেয়ার খুঁজে বুকিং করতে পারবেন। জমির যেকোনো সমস্যার জন্য আমরা সহজ সমাধান দিই।",
  },
  {
    question: "জিমেযােগ কী কী সার্ভিস পাব?",
    answer:
  ...
  },
  {
    ...
    answer:
      "👉 জিমেযাগ-এ আপনার এলাকা সিলেক্ট করুন।\n👉 সার্ভেয়ারদের প্রোফাইল ও রেটিং দেখুন।\n👉 পছন্দের সার্ভেয়ার বেছে নিয়ে তারিখ ও সময় বুক করুন।",
  },
  {
    question: "সার্ভেয়ারদের কিভাবে বিশ্বাস করব?",
    answer:
      "জিমেযাগ-এর সকল সার্ভেয়ারের প্রোফাইল ম্যানুয়ালি ভেরিফাইড। এছাড়াও, আগের ক্লায়েন্টদের রিভিউ পড়তে পারবেন।",
  },
  {
    question: "সমস্যা হলে কী করব?",
    answer:
      "আমাদের একটি সাপোর্ট টিম রয়েছে। জিমেযাগ-এ যোগাযোগ অপশনে আপনার মেসেজ পাঠান। আমরা দ্রুত সাহায্য করার চেষ্টা করব।",
  },
  {
    question: "সার্ভেয়ার হিসেবে যুক্ত হতে চান?",
    answer:
      "জিমেযাগ-এ 'Surveyor Register'-এ ক্লিক করে আপনার বিস্তারিত তথ্য সাবমিট করুন।",
  },
];
